...
function getExchangeRate(){
    ...
    exchangeRateTxt.innerText = "Berechne den Wechselkurs...";
    let url = `https://v6.exchangerate-api.com/v6/efc2c15ed9104987f079251f/latest/${fromCurrency.value}`;
    ...
    fetch(url).then(response => response.json()).then(result =>{
        ...
        exchangeRateTxt.innerText = "Ein Fehler ist aufgetreten";
    });
}