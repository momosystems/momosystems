console.log("JavaScript erfolgreich geladen! indexnetworkvisulizerchromedino.js");
...
class NetworkVisualizer {
	...
	drawTitle() {
		...
		textStyle(BOLD);
		fill(0);
		text("Die besten der letzten Generation", this.startX + this.width / 2, this.startY);
	}
